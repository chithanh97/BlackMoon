...
<?php $__env->startSection('description', $news->description); ?>
<?php $__env->startSection('o_title', $news->title); ?>
<?php $__env->startSection('image', $news->image); ?>
<?php $__env->startSection('type', 'article'); ?>
<?php $__env->startSection('url', $_SERVER['SERVER_NAME'].'/'.$news->subject.'.html'); ?>
		...
		<div class="news-content">
			...
			<div class="share-link">
				<ul class="social-sharing list-unstyled">
					...
					<li>
						<a class="btn btn-twitter" target="_blank" href="https://twitter.com/intent/tweet?text=<?php echo e($news->name); ?>&amp;url=<?=getCurrentPageURL();?>&amp;" onclick="window.open(this.href, 'mywin','left=50,top=50,width=600,height=350,toolbar=0'); return false;">
...
<?php echo $__env->make('frontend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\GitHub\BlackMoon\resources\views/frontend/page/news.blade.php ENDPATH**/ ?>