				...
				<div class="white_card_header">
					<div class="box_header m-0">
						...
						<div class="header_more_tool">
							<div class="dropdown">
								<span class="" id="">
									<button class="btn btn-primary add-button"><a href="<?php echo e(route('items.add')); ?>" class='text-light'><i class="fa fa-plus-circle text-light" aria-hidden="true"></i> Thêm</a></button>
								</span>
							</div>
						</div>
					</div>
						...
						<table class="table pt-0 table-striped" id='tableData'>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<img class="thumbnail" src="<?php echo e($value->image == '' ? getImageDefault() : getFirstImage($value->image)); ?>" alt="">
									</td>
									...
									<td>
										<div class="<?php echo e($value->hot == 1 ? 'active' : ''); ?> field-status changestatus" data-table='items' data-field='hot' data-id='<?php echo e($value->id); ?>'></div>
									</td>
									<td>
										<div class="<?php echo e($value->status == 1 ? 'active' : ''); ?> status changestatus" data-table='items' data-field='status' data-id='<?php echo e($value->id); ?>'></div>
									</td>
									<td class="column-action">
										<a href="<?php echo e(route('items.edit', $value->id)); ?>" class="btn-edit">
											<i class="fa fa-pencil"></i>
										</a>
										<a href="javascript:if(confirm('Bạn chắc chắn muốn xóa?')) window.location.href = '<?php echo e(route('items.delete', $value->id)); ?>' ;
											" class="btn-delete">
...
<script>
	...
	function deleteAll(){
		if(confirm('Bạn chắc chắn muốn xóa?')) {
			...
			window.location.href = '<?php echo e(route("items.deleteall")); ?>?value=' + JSON.stringify(value);
		}
	}
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BlackMoon\Documents\Github\BlackMoon\resources\views/backend/page/items/index.blade.php ENDPATH**/ ?>