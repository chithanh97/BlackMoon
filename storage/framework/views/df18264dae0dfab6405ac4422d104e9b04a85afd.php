...
<?php $__env->startSection('title', 'Danh sách Map'); ?>
				...
				<div class="white_card_header">
					<div class="box_header m-0">
						...
						<div class="header_more_tool">
							<div class="dropdown">
								<span class="" id="">
									<button class="btn btn-primary add-button"><a href="<?php echo e(route('map.add')); ?>" class='text-light'><i class="fa fa-plus-circle text-light" aria-hidden="true"></i> Thêm</a></button>
								</span>
							</div>
						</div>
					</div>
						...
						<table class="table pt-0 table-striped" id='tableData'>
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="<?php echo e($value->status == 1 ? 'active' : ''); ?> status changestatus" data-table='Map' data-field='status' data-id='<?php echo e($value->id); ?>'></div>
									</td>
									<td class="column-action">
										<a href="<?php echo e(route('map.edit', $value->id)); ?>" class="btn-edit">
											<i class="fa fa-pencil"></i>
										</a>
										<a href="javascript:if(confirm('Bạn chắc chắn muốn xóa?')) window.location.href = '<?php echo e(route('map.delete', $value->id)); ?>' ;
											" class="btn-delete">
...
<script>
	...
	function deleteAll(){
		if(confirm('Bạn chắc chắn muốn xóa?')) {
			...
			window.location.href = '<?php echo e(route("map.deleteall")); ?>?value=' + JSON.stringify(value);
		}
	}
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BlackMoon\Documents\Github\BlackMoon\resources\views/backend/page/map/index.blade.php ENDPATH**/ ?>