						...
						<div class="panel panel-default panel-light">
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<input type="text" name="sort" class="form-control" value="<?php echo e($item->sort); ?>" />
								</div>
							</div>
						</div>
					</div>
...
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\GitHub\BlackMoon\resources\views/backend/page/video/edit.blade.php ENDPATH**/ ?>