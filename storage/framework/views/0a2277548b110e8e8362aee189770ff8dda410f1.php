				...
				<div class="row">
					<div class="col-sm-3">
						...
						<div id="wrap_all_image">
							<input type="hidden" id="all_image_child" name="all_image_child" value="<?php echo e(old('all_image_child') == '' ? $item->image : old('all_image_child')); ?>">
						...
						<div class="panel panel-default panel-light">
							<div class="panel-body">
								<div class="form-group">
									...
									<input type="text" name="name" class="form-control get-subject" data-table='news' value="<?php echo e(old('name') == '' ? $item->name : old('name')); ?>" />
								</div>
								<div class="form-group">
									<label class="control-label">
										Danh mục
								...
								<div class="form-group">
									...
									<input type="text" name="price" class="form-control money" data-table='news' value="<?php echo e(old('price') == '' ? $item->price : old('price')); ?>" />
								</div>
								<div class="form-group">
									<label class="control-label">
										Giá giảm
									</label>
									<input type="text" name="sell_price" class="form-control money" data-table='news' value="<?php echo e(old('sell_price') == '' ? $item->sell_price : old('sell_price')); ?>" />
								</div>
								<div class="form-group">
									<label class="control-label">
										Giá giảm % (* ưu tiên nếu có 2 giá giảm)
									</label>
									<input type="text" name="sell_percent" class="form-control" data-table='news' value="<?php echo e(old('sell_percent') == '' ? $item->sell_percent : old('sell_percent')); ?>" />
								</div>
								<div class="form-group">
									<label class="control-label">Mô tả</label>
									<textarea rows="5" name="detail_short" class="form-control"><?php echo e(old('detail_short') == '' ? $item->detail_short : old('detail_short')); ?></textarea>
								</div>
								<div class="form-group">
									<label class="control-label">Chi tiết</label>
									<textarea name="detail" class="form-control tinymce-editor" id="txtDetailShort"><?php echo e(old('detail') == '' ? $item->detail : old('detail')); ?></textarea>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="panel panel-default panel-light">
							<div class="panel-body">
								<div class="form-group">
									...
									<input type="text" name="title" class="form-control countW" id="seo_title" value="<?php echo e(old('title') == '' ? $item->title : old('title')); ?>" maxlength="70" />
								</div>
								<div class="form-group">
									<div>
									...
									<input type="text" name="description" class="form-control countW" id="seo_description" value="<?php echo e(old('description') == '' ? $item->description : old('description')); ?>" maxlength="160" />
								</div>
								<div class="form-group">
									<div>
										<label class="control-label">Từ khóa</label>
									</div>
									<input type="text" name="keyword" class="form-control" id="seo_keyword" value="<?php echo e(old('keyword') == '' ? $item->keyword : old('keyword')); ?>" />
								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" name="subject" class="form-control" value="<?php echo e(old('subject') == '' ? $item->subject : old('subject')); ?>" />
									</div>
								</div>
								<div class="form-group">
									<label class="label-control">Link khác</label>
									<input type="text" name="link" class="form-control" value="<?php echo e(old('link') == '' ? $item->link : old('link')); ?>" />
								</div>
							</div>
						</div>
					</div>
						...
						<div class="panel panel-default panel-light">
							<div class="panel-body">
								<div class="form-group">
									...
									<input type="text" name="sort" class="form-control" value="<?php echo e(old('sort') == '' ? $item->sort : old('sort')); ?>" />
								</div>
							</div>
						</div>
					</div>
...
<script>
	...
	function delete_img_product_thumbnail(el){
		let image = '<?php echo e(getImageDefault()); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\GitHub\BlackMoon\resources\views/backend/page/items/edit.blade.php ENDPATH**/ ?>