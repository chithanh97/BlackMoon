						...
						<div class="panel panel-default panel-light">
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<input type="text" name="price" class="form-control" data-table='news' value="<?php echo e(old('price') == '' ? $item->price : old('price')); ?>" />
								</div>
								<div class="form-group">
									<label class="control-label">
										Giá giảm
									</label>
									<input type="text" name="sell_price" class="form-control" data-table='news' value="<?php echo e(old('sell_price') == '' ? $item->sell_price : old('sell_price')); ?>" />
								</div>
								<div class="form-group">
									<label class="control-label">
