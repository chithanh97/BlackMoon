	...
	<div class="row items-push">
		...
		<div class="col-sm-5 text-right hidden-xs">
			<ol class="breadcrumb push-10-t">
				...
				<li><a href="<?php echo e(route('language')); ?>">Ngôn ngữ</a>
				</li>
				<li>Thêm mới</li>
			</ol>
		</div>
					...
					<div class="col-sm-9">
						<div class="form-group" style="margin-bottom: 0;">
							<div class="btn-gr">
								...
								<button onclick="javascript:window.location.href = '<?php echo e(route('language')); ?>' " type="button" name="goback" class="btn btn-sm btn-danger">Quay lại</button>
							</div>
						</div>
					</div>
				</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BlackMoon\Documents\GitHub\BlackMoon\resources\views/backend/page/language/store.blade.php ENDPATH**/ ?>