	...
	<div class="row items-push">
		...
		<div class="col-sm-5 text-right hidden-xs">
			<ol class="breadcrumb push-10-t">
				...
				<li><a href="<?php echo e(route('slide')); ?>">Slide</a>
				</li>
				<li>Chỉnh sửa</li>
			</ol>
		</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BlackMoon\Documents\GitHub\BlackMoon\resources\views/backend/page/slide/edit.blade.php ENDPATH**/ ?>