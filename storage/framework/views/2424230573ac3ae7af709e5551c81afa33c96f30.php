						...
						<div class="panel panel-default panel-light">
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<input type="text" name="sell_percent" class="form-control" data-table='news' value="<?php echo e(old('sell_percent')); ?>" />
								</div>
								<div class="form-group">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BlackMoon\Documents\Github\BlackMoon\resources\views/backend/page/items/store.blade.php ENDPATH**/ ?>