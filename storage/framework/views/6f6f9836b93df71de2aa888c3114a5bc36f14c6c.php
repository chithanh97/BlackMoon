						...
						<div class="panel panel-default panel-light">
							<div class="panel-body">
								<div class="form-group">
									...
									<input type="text" name="name" class="form-control get-subject" data-table='itemcategory' value="" />
								</div>
								<div class="form-group">
									<label class="control-label">
										Danh mục
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\matmado\resources\views/backend/page/newscategory/store.blade.php ENDPATH**/ ?>