...
<?php $__env->startSection('title', 'Chỉnh sửa Video'); ?>
						...
						<div class="panel panel-default panel-light">
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<textarea name="detail" class="form-control tinymce-editor"><?php echo e(old('detail') == '' ? $item->detail : old('detail')); ?></textarea>
								</div>
								<div class="form-group">
...
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BlackMoon\Documents\GitHub\BlackMoon\resources\views/backend/page/map/edit.blade.php ENDPATH**/ ?>