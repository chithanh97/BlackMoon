						...
						<div class="panel panel-default panel-light">
							<div class="panel-body">
								<div class="form-group">
									...
									<input type="text" name="name" class="form-control get-subject" data-table='itemcategory' value="<?php echo e(old('name') == '' ? $item->name : old('name')); ?>" />
								</div>
								<div class="form-group">
									<label class="control-label">
										Danh mục
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\GitHub\BlackMoon\resources\views/backend/page/itemcategory/edit.blade.php ENDPATH**/ ?>