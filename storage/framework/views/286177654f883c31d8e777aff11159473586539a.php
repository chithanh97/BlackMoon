...
<div class="login-page">
	...
	<div class="form-structor">
		<div class="signup <?php echo e((old('register') != '' || $errors->first('register') != '' ) ? '' : 'slide-up'); ?>">
			<h2 class="form-title" id="signup"><span>hoặc</span>Đăng ký</h2>
			<div class="form-holder">
				<form class="form-register" action="<?php echo e(route('register')); ?>" method="POST">
					<?php echo csrf_field(); ?>
					<input type="hidden" class="input" name="register" value="1" />
					<input type="text" class="input" name="name" placeholder="Họ tên" value="<?php echo e(old('name')); ?>" />
					<input type="email" class="input" name="email" placeholder="Email" value="<?php echo e(old('email')); ?>" />
		...
		<div class="login <?php echo e((old('register') != '' || $errors->first('register') != '' ) ? 'slide-up' : ''); ?>">
			<div class="center">
				<h2 class="form-title" id="login"><span>Hoặc</span>Đăng nhập</h2>
				<div class="form-holder">
					<form action="<?php echo e(route('login')); ?>" method="POST" class="form-login">
						<?php echo csrf_field(); ?>
						<input type="email" class="input" placeholder="Email" name="l_email" value="<?php echo e(old('l_email')); ?>" />
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\GitHub\BlackMoon\resources\views/auth/user/login.blade.php ENDPATH**/ ?>