							...
							<tbody>
								...
								<tr>
									...
									<td class="column-action">
										...
										<a href="javascript:if(confirm('Bạn chắc chắn muốn xóa?')) window.location.href = '<?php echo e(route('news.delete', $value->id)); ?>' ;
											" class="btn-delete">
...
<script>
	...
	function deleteAll(){
		if(confirm('Bạn chắc chắn muốn xóa?')) {
			...
			window.location.href = '<?php echo e(route("news.deleteall")); ?>?value=' + JSON.stringify(value);
		}
	}
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\BlackMoon\Documents\Github\BlackMoon\resources\views/backend/page/news/index.blade.php ENDPATH**/ ?>