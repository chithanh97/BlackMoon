		...
		<div class="card">
			<div class="card-body">
				<div class="row">
					<div class="col-9">
						<div class="d-flex align-items-center align-self-start">
							<h3 class="mb-0"><?php echo e(number_format($data->total, 0, '.', '.').getMoney()); ?></h3>
						</div>
					</div>
					<div class="col-3">
						<div class="icon icon-box-success ">
			...
			<div class="card-body">
				...
				<div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
					...
					<div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
						<h6 class="font-weight-bold mb-0"><?php echo e(number_format($data->countCOD, 0, '.', '.').getMoney()); ?></h6>
					</div>
				</div>
				<div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
					<div class="text-md-center text-xl-left">
					...
					<div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
						<h6 class="font-weight-bold mb-0"><?php echo e(number_format($data->countMoMo, 0, '.', '.').getMoney()); ?></h6>
					</div>
				</div>
			</div>
		</div>
	...
	if ($("#transaction-history").length) {
		...
		var transactionhistoryChartPlugins = {
			beforeDraw: function(chart) {
				...
				var text = "<?php echo e(number_format($data->total, 0, '.', '.').getMoney()); ?>",
