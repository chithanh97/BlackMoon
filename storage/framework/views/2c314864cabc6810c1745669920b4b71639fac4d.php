...
<?php $__env->startSection('title', 'Khôi phục mật khẩu'); ?>
		...
		<div class="content">
			...
			<div class="row">
				<div class="block-content col-md-12">
					<form action="<?php echo e(route('front.saverestorepass')); ?>" method="POST">
						<?php echo csrf_field(); ?>
						<div class="form-group">
							<input type="hidden" name="token" class="form-control" value="<?php echo e($token); ?>">
						</div>
						<div class="form-group">
...
<?php echo $__env->make('frontend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Documents\GitHub\BlackMoon\resources\views/auth/user/restorepass.blade.php ENDPATH**/ ?>