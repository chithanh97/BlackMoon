tinymce.init({
  ...
  + "textarea[cols|rows|disabled|name|readonly],tt,var,big,video[*]",

  external_filemanager_path: "/storage/filemanager/",
  filemanager_title: "Responsive Filemanager" ,
  external_plugins: {
    "filemanager" : "/storage/filemanager/plugin.min.js"
  },
  extended_valid_elements : "iframe[src|width|height|name|align],style[*],section[*],marquee[scrolldelay|scrollamount],script[language|type|src],video[*]",
  custom_elements: "marquee",
  schema: "html5",
  media_url_resolver: function (data, resolve) {
    if (data.url.indexOf('youtube.com') !== -1) {
      var embedHtml = '<p class="tvideo"><iframe src="https://www.youtube.com/embed/' + data.url.split('v=')[1] +
