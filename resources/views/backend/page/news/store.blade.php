						...
						<div class="panel panel-default panel-light">
							<div class="panel-body">
								<div class="form-group">
									...
									<input type="text" name="name" class="form-control get-subject" data-table='news' value="{{old('name')}}" />
								</div>
								<div class="form-group">
									<label class="control-label">
										Danh mục
								...
								<div class="form-group">
									...
									<textarea rows="5" name="detail_short" class="form-control">{{old('detail_short')}}</textarea>
								</div>
								<div class="form-group">
