						...
						<div class="panel panel-default panel-light">
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<input type="text" name="price" class="form-control money" data-table='news' value="{{old('price')}}" />
								</div>
								<div class="form-group">
									<label class="control-label">
										Giá giảm
									</label>
									<input type="text" name="sell_price" class="form-control money" data-table='news' value="{{old('sell_price')}}" />
								</div>
								<div class="form-group">
									<label class="control-label">
