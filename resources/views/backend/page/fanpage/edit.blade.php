...
@section('title', 'Chỉnh sửa Fanpage')
@push('styles')
<style>
	...
	<div class="row items-push">
		...
		<div class="col-sm-5 text-right hidden-xs">
			<ol class="breadcrumb push-10-t">
				...
				<li><a href="{{ route('fanpage') }}">Fanpage</a>
				</li>
				<li>Chỉnh sửa</li>
			</ol>
		</div>
						...
						<div class="panel panel-default panel-light">
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<input type="text" name="detail" class="form-control" value="{{ old('detail') == '' ? $item->detail : old('detail') }}" />
								</div>
								<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="form-group" style="margin-bottom: 0;">
							<div class="btn-gr">
								...
								<button onclick="javascript:window.location.href = '{{ route('fanpage') }}' " type="button" name="goback" class="btn btn-sm btn-danger">Quay lại</button>
							</div>
						</div>
					</div>
				</div>
